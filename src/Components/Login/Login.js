...
const Login = () => {
    ...
    return (
        <div>
            <h1 style={{ color: 'red' , marginTop:'10px' }}>Please Login</h1>
            {/* <button onClick={handleGoogleSignIn} className="btn btn-primary">Sign Up</button> */}


                <div className="damn-form">
            <button onClick={handleGoogleSignIn} id="xx"  className="btn btn-primary ">Google Sign In</button>
            <br />
            <br />
